...
if __name__ == '__main__':
    ...
    # User credentials
    moneykeeper_config = load_config(filename='helper/database.ini', section='moneykeeper')
    username = moneykeeper_config['username']
    password = moneykeeper_config['password']

    # Run functions
    token = get_bearer_token(username=username, password=password, base_url='https://moneykeeperapp.misa.vn/g1/api/auth/api/v1/auths/loginforweb')
